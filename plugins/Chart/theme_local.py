...
class BaseTheme(ABC):
    ...
    arctap_designant_path = os.path.join(SRC_PATH, 'models/tap_tomato.png')

    thickness_arc = 10
    thickness_skyline = 2

    # for comment on the left side of the chart
    font_Exo_SemiBold_20 = ImageFont.truetype(os.path.join(SRC_PATH, 'Fonts/Exo-SemiBold.ttf'), 20)
    # for slogan
    font_Exo_SemiBold_40 = ImageFont.truetype(os.path.join(SRC_PATH, 'Fonts/Exo-SemiBold.ttf'), 40)
    # for song title at text area
    font_Kazesawa_Regular_54 = ImageFont.truetype(os.path.join(SRC_PATH, 'Fonts/ShangguSans-Bold.ttf'), 54)
    # for artist / chart designer / jacket designer at text area
    font_SourceHanMonoSC_Regular_40 = ImageFont.truetype(os.path.join(SRC_PATH, 'Fonts/ShangguSans-Bold.ttf'), 40)
    # for statistics at text area
    font_SourceHanMonoSC_Regular_34 = ImageFont.truetype(os.path.join(SRC_PATH, 'Fonts/ShangguSans-Bold.ttf'), 34)


class LightTheme(BaseTheme):
    tile_path = os.path.join(SRC_PATH, 'img/track.png')
    tap_path = os.path.join(SRC_PATH, 'img/note.png')
    hold_path = os.path.join(SRC_PATH, 'img/note_hold.png')
    arctap_path = os.path.join(SRC_PATH, 'models/tap_l.png')
    arctap_sfx_path = os.path.join(SRC_PATH, 'models/sfx_l_note.jpg')
    default_bg_path = os.path.join(SRC_PATH, 'img/bg/base_light.jpg')
...
class ConflictTheme(BaseTheme):
    tile_path = os.path.join(SRC_PATH, 'img/track_dark.png')
    tap_path = os.path.join(SRC_PATH, 'img/note_dark.png')
    hold_path = os.path.join(SRC_PATH, 'img/note_hold_dark.png')
    arctap_path = os.path.join(SRC_PATH, 'models/tap_d.png')
    arctap_sfx_path = os.path.join(SRC_PATH, 'models/sfx_d_note.jpg')
    default_bg_path = os.path.join(SRC_PATH, 'img/bg/base_conflict.jpg')
